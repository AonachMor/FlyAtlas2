// TissueTriplet
// Models male/female/larval FlyTissue 'triplet' with same uniTissueID
...
public class TissueTriplet
{
	...
	private boolean mir;			// flag that tissue has Micro-array data
	
	public TissueTriplet(int uniTissueID, Tissue maleTissue, Tissue femaleTissue, Tissue larvalTissue, 
							int displayPosition, String uniTissueName, boolean reference, boolean mir)
	{
	...
	public String toString()
	{
		return("UniTissueID: " + uniTissueID + ", Male tissue: " + maleTissue + ",  Female tissue: " + femaleTissue + ", "
				+ "Larval tissue: " + larvalTissue + ", Display position: " + displayPosition + ", "
						+ "UniTissue Name: " + uniTissueName + ", Reference: " + reference + ", Mir: " + mir);
	}
}
