/*
Class to handle JDBC connections to FlyGutDB on localhost
Based on examples in JDBC chapters in various O'Reilly books
Version for new drivers
DPL 03.04.2014 and 27.11.2015
*/

import java.sql.*;

public class ConnectMG
{
	Connection conn = null;	
	String username = "charles";
	String password = "atlas";
	String defaultHost = "jdbc:mysql://localhost/FlyGutDB?useUnicode=true&characterEncoding=UTF-8";
